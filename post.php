...
<?php $this->need('header.php');if ($this->is('post')) { $content = $this->content; echo generate_toc($content);} ?>
            ...
            <div class="article-details">
                ...
                <footer class="article-time">
                    ...
                    <div>
                        ...
                        <time class="article-time--reading">阅读时长
                            <?php $content = $this->content; $readingTime = getReadingTime($content);echo isset($readingTime) ? $readingTime . '分钟' : '未知'; ?>
                        </time>
                    </div>
                </footer> 
            </div>
